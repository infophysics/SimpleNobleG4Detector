...
RegContainer::RegContainer()
{
	...
	const std::string DataDir( "/home/ncarrara/physics/SimpleNobleG4Detector/Data/" );

	std::string tmp;
	
	// Load the G4 data sources.
	std::cout << "Loading G4 dataset: " << "Muons" << "..." << std::endl;
	G4Input Muons( "Muons", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/Muon_10keV.root" );
	G4Inputs["Muons"] = G4Input( "Muons", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/Muon_10keV.root" );
	std::cout << "Loading G4 dataset: " << "Protons" << "..." << std::endl;
	G4Inputs["Protons"] = G4Input( "Protons", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/Proton_10keV.root" );
	std::cout << "Loading G4 dataset: " << "Deuterons" << "..." << std::endl;
	G4Inputs["Deuterons"] = G4Input( "Deuterons", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/Deuteron_10keV.root" );
	std::cout << "Loading G4 dataset: " << "113Sn_ceK2_364keV" << "..." << std::endl;
	G4Inputs["DM_113Sn_ceK2_364keV"] = G4Input( "113Sn_ceK2_364keV", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/113Sn_ceK2_364keV.root" );
	std::cout << "Loading G4 dataset: " << "207Bi_ceK3_976keV" << "..." << std::endl;
	G4Inputs["DM_207Bi_ceK3_976keV"] = G4Input( "207Bi_ceK3_976keV", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/207Bi_ceK3_976keV.root" );
	std::cout << "Finished loading the G4 datasets." << std::endl;
	G4Inputs["DM_241Am_gamma_59keV"] = G4Input( "241Am_gamma_59keV", "/home/ncarrara/physics/SimpleNobleG4Detector/G4/build/241Am_gamma_59keV.root" );
	std::cout << "Finished loading the G4 datasets." << std::endl;
